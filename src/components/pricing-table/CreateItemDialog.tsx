...
export function CreateItemDialog({ open, onClose, categoryId }: CreateItemDialogProps) {
  const { createItem, loading } = usePricingTable();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await createItem({
      ...
      base_price: formData.base_price || formData.price,
