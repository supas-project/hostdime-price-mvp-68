...
export function HelpTooltip({
  ...
  return <TooltipProvider>
      <Tooltip delayDuration={300}>
        <TooltipTrigger className={cn("cursor-help inline-flex items-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-full", className)} aria-label={title}>
          {icon}
