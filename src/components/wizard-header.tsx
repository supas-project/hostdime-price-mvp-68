...
export function WizardHeader({ components, currentStep, onStepClick }: WizardHeaderProps) {
  return (
        ...
        return (
          <button
            ...
            className={cn(
              ...
              isComplete && "bg-primary/20 text-foreground",
          ...
          >
            ...
            {isComplete && <Icons.Check className="h-4 w-4" />}
          </button>
        );
      })}
    </div>
